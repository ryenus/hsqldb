...
(
    ...
    CUSTOMERID  INTEGER,
    TOTAL       DECIMAL,
    CONSTRAINT SYS_FK_48 FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMER(ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT SYS_FK_52 FOREIGN KEY(INVOICEID) REFERENCES INVOICE(ID) ON DELETE CASCADE,
    CONSTRAINT SYS_FK_53 FOREIGN KEY(PRODUCTID) REFERENCES PRODUCT(ID) ON DELETE CASCADE
);
