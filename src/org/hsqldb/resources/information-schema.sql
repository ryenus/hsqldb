-- author Fred Toussi (fredt@users dot sourceforge.net) version 2.2.9
/*system_procedures*/
...
( 18, 'DBMS VERSION', NULL, '2.3.0', 'CHAR: Version of the implementation software The format is: <part1>.<part2>.<part3>[<part4>] where: <part1> ::= <digit><digit> <part2> ::= <digit><digit> <part3> ::= <digit><digit><digit><digit> <part4> ::= <character representation>' ),
